...
the safety primitive for pure-LN swaps (`doc/sequentia/seqln-step2-pure-ln-swaps-design.md`
in the SequentiaByClaude repo): a swap maker's *incoming* leg is held until the
